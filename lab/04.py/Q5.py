...
restaurant.book_tables(1, "Arbaz Hassan")
restaurant.book_tables(2, "Abdul Rafay")
restaurant.book_tables(3, "Murtaza")
restaurant.customer_order(1, "Pizza and Burger")
restaurant.customer_order(2, "Burger and Fries")
